"""
SkillTwin - Interfaz de línea de comandos para gestión financiera.
Este módulo contiene las funciones interactivas de terminal que no son
necesarias para el servidor web.
"""
